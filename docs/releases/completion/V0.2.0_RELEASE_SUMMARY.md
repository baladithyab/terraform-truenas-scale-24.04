...
- [x] Release URL: https://github.com/baladithyab/terraform-provider-truenas/releases/tag/v0.2.0
...
### Step 1: Download
Go to: https://github.com/baladithyab/terraform-provider-truenas/releases/tag/v0.2.0
...
- **Release Page**: https://github.com/baladithyab/terraform-provider-truenas/releases/tag/v0.2.0
