...
1. Go to: https://github.com/baladithyab/terraform-provider-truenas/releases
...
- **Releases**: https://github.com/baladithyab/terraform-provider-truenas/releases
- **Issues**: https://github.com/baladithyab/terraform-provider-truenas/issues
- **Tag**: https://github.com/baladithyab/terraform-provider-truenas/releases/tag/v0.2.0
